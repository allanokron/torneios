...
export default function SettingsTab({ tournament, onTournamentUpdated }: SettingsTabProps) {
  ...
  return (
    <div style={{ background: 'var(--surface)', borderColor: 'var(--border)' }} className="rounded-xl border">
      {/* Messages */}
      {success && (
        <div style={{ background: 'rgba(184, 224, 0, 0.1)', borderColor: 'rgba(184, 224, 0, 0.2)', color: 'var(--accent-dark)' }} className="mx-5 mt-5 border px-4 py-3 rounded-lg text-sm">
          {success}
        </div>
      )}
      {error && (
        <div style={{ background: '#FEE2E2', borderColor: '#FECACA', color: '#EF4444' }} className="mx-5 mt-5 border px-4 py-3 rounded-lg text-sm">
          {error}
        </div>
      )}

      {/* Section Tabs */}
      <div style={{ borderColor: 'var(--border)' }} className="border-b px-5 pt-4">
        <nav className="flex gap-1 -mb-px">
          {sections.map(s => (
            <button
              key={s.id}
              onClick={() => { setActiveSection(s.id); clearMessages() }}
              style={activeSection === s.id ? { background: 'var(--neutral-50)', color: 'var(--accent-dark)', borderBottomColor: 'var(--accent)' } : { color: 'var(--neutral-400)' }}
      ...
      <div className="p-5">
        ...
        {activeSection === "general" && (
          <div className="space-y-4 max-w-xl">
            ...
            <div>
              ...
              {coverPreview ? (
                <div className="relative">
                  <img src={coverPreview} alt="Capa" style={{ borderColor: 'var(--border)' }} className="w-full h-40 object-cover rounded-lg border" />
                  <button
                    type="button"
                    onClick={removeCoverImage}
                    style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}
                    className="absolute top-2 right-2 rounded-full p-1 shadow-sm border hover:bg-red-50"
                  >
                ...
                <label style={{ borderColor: 'var(--neutral-200)' }} className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer hover:border-green-400 transition-colors">
                  <svg style={{ color: 'var(--neutral-400)' }} className="w-8 h-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <span style={{ color: 'var(--neutral-400)' }} className="text-sm">Clique para enviar uma foto</span>
                  <span style={{ color: 'var(--neutral-400)' }} className="text-xs mt-1">JPG, PNG. Máximo 5MB. Recomendado: 1200x400px.</span>
            ...
            <div style={{ borderColor: 'var(--neutral-100)' }} className="border-t pt-4">
              <h4 style={{ color: 'var(--text)' }} className="text-sm font-medium mb-3">Tipo de Torneio</h4>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-end">
                <label className="flex items-center gap-2 cursor-pointer py-2.5">
                  <input type="checkbox" checked={isPublic} onChange={e => setIsPublic(e.target.checked)} style={{ color: 'var(--accent)' }} className="w-4 h-4 border-gray-300 rounded focus:ring-green-500" />
                  <span style={{ color: 'var(--neutral-600)' }} className="text-sm">Torneio público</span>
                </label>
              </div>
            </div>
            <div style={{ borderColor: 'var(--neutral-100)' }} className="border-t pt-4">
              <h4 style={{ color: 'var(--text)' }} className="text-sm font-medium mb-3">Regras de Adiamento</h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
        ...
        {activeSection === "rules" && (
          <div className="space-y-4 max-w-xl">
            ...
            <div style={{ borderColor: 'var(--neutral-100)' }} className="border-t pt-4">
              <h4 style={{ color: 'var(--text)' }} className="text-sm font-medium mb-3">Tiebreak</h4>
              <div className="space-y-3">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" checked={hasTiebreak} onChange={e => setHasTiebreak(e.target.checked)} style={{ color: 'var(--accent)' }} className="w-4 h-4 border-gray-300 rounded focus:ring-green-500" />
                  <span style={{ color: 'var(--neutral-600)' }} className="text-sm">Habilitar tiebreak</span>
                </label>
                {hasTiebreak && (
                  <div>
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" checked={hasSuperTiebreak} onChange={e => setHasSuperTiebreak(e.target.checked)} style={{ color: 'var(--accent)' }} className="w-4 h-4 border-gray-300 rounded focus:ring-green-500" />
                  <span style={{ color: 'var(--neutral-600)' }} className="text-sm">Habilitar super tiebreak</span>
                </label>
                {hasSuperTiebreak && (
                  <div>
            ...
            <div style={{ borderColor: 'var(--neutral-100)' }} className="border-t pt-4">
              <h4 style={{ color: 'var(--text)' }} className="text-sm font-medium mb-3">Partida</h4>
              <div className="grid grid-cols-2 gap-4">
                <div>
            ...
            <div style={{ borderColor: 'var(--neutral-100)' }} className="border-t pt-4">
              <h4 style={{ color: 'var(--text)' }} className="text-sm font-medium mb-3">Regras Gerais</h4>
            ...
            <div style={{ borderColor: 'var(--neutral-100)' }} className="border-t pt-4">
              <h4 style={{ color: 'var(--text)' }} className="text-sm font-medium mb-3">Desistência e Penalidades</h4>
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-4">
                  <div>
        ...
        {activeSection === "scoring" && (
          <div className="space-y-5 max-w-xl">
            {showRankingWarning && (
              <div style={{ background: '#FEF3C7', borderColor: '#FDE68A' }} className="border rounded-lg p-4">
                <div className="flex gap-3">
                  <svg style={{ color: '#D97706' }} className="w-5 h-5 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" />
                  </svg>
                  <div>
                    <p style={{ color: '#92400E' }} className="text-sm font-medium">Atenção: Rankings serão resetados</p>
                    ...
                    <div className="flex gap-2 mt-3">
                      <button onClick={saveScoring} disabled={saving} style={{ background: '#D97706', color: 'white' }} onMouseEnter={e => (e.currentTarget.style.background = '#B45309')} onMouseLeave={e => (e.currentTarget.style.background = '#D97706')} className="px-3 py-1.5 text-sm font-medium rounded-xl transition-colors disabled:opacity-50">
                        {saving ? "Salvando..." : "Confirmar e Salvar"}
                      </button>
                      <button onClick={() => setShowRankingWarning(false)} style={{ color: 'var(--neutral-500)', background: 'var(--surface)', borderColor: 'var(--border)' }} className="px-3 py-1.5 text-sm font-medium border rounded-xl hover:bg-gray-50 transition-colors">
                        Cancelar
                      </button>
                    </div>
                  </div>
            ...
            <div>
              <h4 style={{ color: 'var(--text)' }} className="text-sm font-medium mb-3">Pontuação por resultado</h4>
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-4">
                  <div>
            ...
            <div style={{ borderColor: 'var(--neutral-100)' }} className="border-t pt-4">
              <h4 style={{ color: 'var(--text)' }} className="text-sm font-medium mb-3">Walkover</h4>
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-4">
                  <div>
        ...
        {activeSection === "tiebreaker" && (
          <div className="space-y-5 max-w-xl">
            <div>
              <h4 style={{ color: 'var(--text)' }} className="text-sm font-medium mb-2">Regras de Desempate</h4>
              <p style={{ color: 'var(--neutral-400)' }} className="text-xs mb-4">
              ...
              <div className="space-y-3">
                {tiebreakerCriteria.map((criteria, index) => (
                  <div key={criteria} style={{ borderColor: 'var(--border)', background: 'var(--neutral-50)' }} className="flex items-center gap-3 p-3 rounded-lg border">
                    <span style={{ background: 'var(--accent)' }} className="w-6 h-6 text-white rounded-full flex items-center justify-center text-xs font-bold">
                      {index + 1}
                    </span>
                    <div className="flex-1">
                      ...
                      <p style={{ color: 'var(--neutral-400)' }} className="text-xs">
          ...
          <div className="space-y-5 max-w-xl">
            <div>
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span style={{ color: 'var(--text)' }} className="text-sm font-medium">Habilitar Jogo Desafio</span>
              </label>
              <p style={{ color: 'var(--neutral-400)' }} className="text-xs mt-1 ml-6">
            ...
            {challengeEnabled && (
              <>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p style={{ color: 'var(--neutral-400)' }} className="text-xs mt-1">0 = ilimitado</p>
                      </div>
                      <div>
                ...
                <div style={{ borderColor: 'var(--neutral-100)' }} className="border-t pt-4">
                  <h4 style={{ color: 'var(--text)' }} className="text-sm font-medium mb-3">Multiplicadores</h4>
                  <p style={{ color: 'var(--neutral-400)' }} className="text-xs mb-3">
                ...
                <div style={{ borderColor: 'var(--neutral-100)' }} className="border-t pt-4">
                  <h4 style={{ color: 'var(--text)' }} className="text-sm font-medium mb-3">Contabilização</h4>
                  <div className="space-y-3">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" checked={challengeCountWins} onChange={e => setChallengeCountWins(e.target.checked)} style={{ color: 'var(--accent)' }} className="w-4 h-4 border-gray-300 rounded focus:ring-green-500" />
                      <span style={{ color: 'var(--neutral-600)' }} className="text-sm">Contabilizar vitórias/derrotas no ranking geral</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" checked={challengeCountSets} onChange={e => setChallengeCountSets(e.target.checked)} style={{ color: 'var(--accent)' }} className="w-4 h-4 border-gray-300 rounded focus:ring-green-500" />
                      <span style={{ color: 'var(--neutral-600)' }} className="text-sm">Contabilizar sets no ranking geral</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" checked={challengeCountGames} onChange={e => setChallengeCountGames(e.target.checked)} style={{ color: 'var(--accent)' }} className="w-4 h-4 border-gray-300 rounded focus:ring-green-500" />
                      <span style={{ color: 'var(--neutral-600)' }} className="text-sm">Contabilizar games no ranking geral</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" checked={challengeShowColumn} onChange={e => setChallengeShowColumn(e.target.checked)} style={{ color: 'var(--accent)' }} className="w-4 h-4 border-gray-300 rounded focus:ring-green-500" />
                      <span style={{ color: 'var(--neutral-600)' }} className="text-sm">Mostrar coluna de desafio no ranking</span>
                    </label>
                  </div>
                </div>

                <div style={{ background: '#EFF6FF', borderColor: '#BFDBFE', color: '#1E40AF' }} className="border rounded-lg p-4 text-sm">
        ...
        {activeSection === "courts" && (
          <div className="space-y-4 max-w-xl">
            ...
            {/* Courts list */}
            {courts.length === 0 ? (
              <p style={{ color: 'var(--neutral-400)' }} className="text-sm text-center py-6">Nenhuma quadra cadastrada</p>
            ) : (
              <div className="space-y-2">
                {courts.map(court => (
                  <div key={court.id} style={{ borderColor: 'var(--neutral-100)' }} className="flex items-center gap-3 p-3 rounded-lg border hover:bg-gray-50 transition-colors">
                    {editingCourt === court.id ? (
                      <>
                        ...
                        <button onClick={() => updateCourt(court.id)} style={{ color: 'var(--accent)' }} className="text-sm hover:text-green-700 font-medium">
                          Salvar
                        </button>
                        <button onClick={() => setEditingCourt(null)} style={{ color: 'var(--neutral-400)' }} className="text-sm hover:text-gray-700">
                          Cancelar
                        </button>
                      </>
                    ) : (
                      <>
                        <div style={{ background: '#EFF6FF' }} className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0">
                          <svg style={{ color: '#2563EB' }} className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4h16v16H4V4zm0 8h16M9 4v16M15 4v16" />
                          </svg>
                        </div>
                        <div className="flex-1 min-w-0">
                          <p style={{ color: 'var(--text)' }} className="text-sm font-medium">{court.name}</p>
                          {court.surfaceType && <p style={{ color: 'var(--neutral-400)' }} className="text-xs">{court.surfaceType === "hard" ? "Quadra Dura" : court.surfaceType === "clay" ? "Quadra de Saibro" : court.surfaceType === "grass" ? "Quadra de Grama" : court.surfaceType}</p>}
                        </div>
                        <button onClick={() => { setEditingCourt(court.id); setEditCourtName(court.name); setEditCourtSurface(court.surfaceType || ""); }} style={{ color: 'var(--neutral-400)' }} className="text-sm hover:text-gray-700">
                          Editar
                        </button>
